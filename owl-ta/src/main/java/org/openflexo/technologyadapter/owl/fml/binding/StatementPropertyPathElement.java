 ...
 *
 */
public class StatementPropertyPathElement extends SimplePathElementImpl {
	...
	public StatementPropertyPathElement(IBindingPathElement parent, Bindable bindable) {
		super(parent, PROPERTY, null, bindable); // Type is dynamically retrieved
